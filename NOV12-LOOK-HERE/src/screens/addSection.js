// src/screens/AddSectionScreen.js
...
const styles = StyleSheet.create({
  container: { flex: 1, padding: 16, backgroundColor: "#FCF8E6" },
  input: { height: 44, backgroundColor: "#fff", borderRadius: 8, paddingHorizontal: 10 },
  typeBtn: { padding: 10, backgroundColor: "#fff", marginRight: 8, borderRadius: 6 },
  active: { backgroundColor: "#9EB995" },
  createBtn: { marginTop: 16, backgroundColor: "#9EB995", padding: 12, borderRadius: 8, alignItems: "center" },
});
